...
<head>
    ...
    <title>Register - Dipika Store</title>
        ...
        <div class="w-full max-w-md">
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
                ...
                <div class="px-8 pt-8 pb-6 border-b border-gray-100" style="background-color: #FDFBF7;">
                    ...
                    <p class="text-gray-500 text-sm text-center mt-1">Join us for fresh groceries</p>
                </div>
                    ...
                    <form action="{{ route('register.post') }}" method="POST" class="space-y-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required autofocus
                                ...
                                style="focus:ring-color: #2D6A4F;" placeholder="John Doe">
                        </div>
